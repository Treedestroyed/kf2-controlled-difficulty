...
function string CDStatsCommand(string CommandString)
{
	...
	{
		Output = "PEBCAK! Available stats are:\nAccuracy, DamageDealt, DamageTaken, DoshEarned, Headshots, HeadshotAccuracy, HealsGiven, HealsReceived, Large Kills, ShotsFired, and ShotsHit.";
	}
 ...
 */
function string GetIndividualPlayerStats(Actor Sender)
{
